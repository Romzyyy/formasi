export default function About() {
    return (
        <div id='Profile' className='mt-4 text-slate-800 w-full px-6 sm:px-10 lg:px-36'>
            <p className='text-xl tracking-wide mt-1'>
                ...
                proses.kesatuan rencana belajar yang mengkaji, menerapkan, dan
                mengembangkan ilmu yang melandasi rekayasa sistem informasi.
                Arah kajian keilmuan dari program studi ini mencakup disiplin,
                proses.
            </p>
            <div className='flex flex-col my-8 gap-8 lg:flex-row'>
                <div className=" md:basis-1/2">
                    <h1 className='font-bold text-xl mb-1'>VISI</h1>
                    <p className='text-lg'>
                ...
                <div className='text-right md:basis-1/2'>
                    <h1 className='font-bold text-xl mb-1'>MISI</h1>
                    <p className='text-lg'>

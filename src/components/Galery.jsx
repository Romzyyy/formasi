...
export default function Galery() {
    return (
        <div className='relative flex flex-col w-full px-72 bg-slate-800 mt-20'>
            <h1 className='my-10 text-3xl font-semibold text-slate-200 cursor-pointer hover:text-slate-50'>
                Galery
            </h1>
            <div className='flex flex-row'>
                <div className='columns-3 mb-10 '>
                    <Image
                        src={'/asd5.jpg'}
                        alt='image'
                        width={1000}
